#ifndef _sky_lua_aggregate_message_h
#define _sky_lua_aggregate_message_h
...
// A message for executing a distributed aggregation lua script across a table.
typedef struct {
    bstring results;
    bstring source;
    lua_State *L;
} sky_lua_aggregate_message;
