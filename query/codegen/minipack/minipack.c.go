...
func Declare_unpack_int(m llvm.Module, c llvm.Context) {
	llvm.AddFunction(m, "minipack_unpack_int", llvm.FunctionType(c.Int64Type(), []llvm.Type{llvm.PointerType(c.Int8Type(), 0), llvm.PointerType(c.Int64Type(), 0)}, false))
}

func Declare_unpack_double(m llvm.Module, c llvm.Context) {
	llvm.AddFunction(m, "minipack_unpack_double", llvm.FunctionType(c.DoubleType(), []llvm.Type{llvm.PointerType(c.Int8Type(), 0), llvm.PointerType(c.Int64Type(), 0)}, false))
}
